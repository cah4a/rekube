...
export function ClusterRoleBinding({
  ...
  return (
    <Resource
      ...
      id="io.k8s.api.rbac.v1beta1.ClusterRoleBinding"
      props={props}
    >
      {children}
    </Resource>
...
export function ClusterRole({
  ...
  return (
    <Resource
      kind="ClusterRole"
      apiVersion="rbac.authorization.k8s.io/v1beta1"
      id="io.k8s.api.rbac.v1beta1.ClusterRole"
      props={props}
    >
      {children}
    </Resource>
...
export function RoleBinding({
  ...
  return (
    <Resource
      kind="RoleBinding"
      apiVersion="rbac.authorization.k8s.io/v1beta1"
      id="io.k8s.api.rbac.v1beta1.RoleBinding"
      props={props}
    >
      {children}
    </Resource>
...
export function Role({
  ...
  return (
    <Resource
      kind="Role"
      apiVersion="rbac.authorization.k8s.io/v1beta1"
      id="io.k8s.api.rbac.v1beta1.Role"
      props={props}
    >
      {children}
    </Resource>
  ...
  return (
    <Item
      ...
      paths={{
        ...
        "io.k8s.api.rbac.v1beta1.RoleBinding": "subjects",
      }}
      value={props}
    />
  );
  ...
  return (
    <Item
      ...
      paths={{
        ...
        "io.k8s.api.rbac.v1beta1.Role": "rules",
      }}
      value={props}
    />
  );
