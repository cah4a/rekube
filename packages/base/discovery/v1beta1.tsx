...
export function EndpointSlice({
  ...
  return (
    <Resource
      ...
      id="io.k8s.api.discovery.v1beta1.EndpointSlice"
      props={props}
    >
      {children}
    </Resource>
...
export function Endpoint({
  ...
  return (
    <Item
      ...
      paths={{ "io.k8s.api.discovery.v1beta1.EndpointSlice": "endpoints" }}
      value={props}
    >
      {children}
    </Item>
...
export function EndpointPort(props: {
  ...
  return (
    <Item
      ...
      paths={{ "io.k8s.api.discovery.v1beta1.EndpointSlice": "ports" }}
      value={props}
    />
  );
}
...
export function ForZone(props: {
  ...
  return (
    <Item
      id="io.k8s.api.discovery.v1beta1.ForZone"
      paths={{ "io.k8s.api.discovery.v1beta1.Endpoint": "hints.forZones" }}
      value={props}
    />
  );
}
