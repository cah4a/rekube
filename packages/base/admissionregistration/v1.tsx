 ...
 *
 * Child components:
 * - matchConditions: {@link MatchCondition}
...
export function RuleWithOperations(props: {
  ...
  return (
    <Item
      ...
      paths={{
        "io.k8s.api.admissionregistration.v1.MutatingWebhook": "rules",
        "io.k8s.api.admissionregistration.v1.ValidatingWebhook": "rules",
      }}
      value={props}
    />
  );
