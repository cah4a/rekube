...
export function VolumeAttachment({
  ...
  return (
    <Resource
      ...
      apiVersion="storage.k8s.io/v1"
      id="io.k8s.api.storage.v1.VolumeAttachment"
      props={childProps}
    >
      {children}
    </Resource>
...
export function CSIDriver({
  ...
  return (
    <Resource
      kind="CSIDriver"
      apiVersion="storage.k8s.io/v1"
      id="io.k8s.api.storage.v1.CSIDriver"
      props={childProps}
    >
      {children}
    </Resource>
...
export function CSINode({
  ...
  return (
    <Resource
      kind="CSINode"
      apiVersion="storage.k8s.io/v1"
      id="io.k8s.api.storage.v1.CSINode"
      props={childProps}
    >
      {children}
    </Resource>
...
export function TokenRequest(props: {
  ...
  return (
    <Item
      ...
      paths={{ "io.k8s.api.storage.v1.CSIDriver": "spec.tokenRequests" }}
      value={props}
    />
  );
}
...
export function CSINodeDriver(props: {
  ...
  return (
    <Item
      ...
      paths={{ "io.k8s.api.storage.v1.CSINode": "spec.drivers" }}
      value={props}
    />
  );
}
