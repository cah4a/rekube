...
export const FlowSchema = ({
  ...
  return (
    <Resource
      id="io.k8s.api.flowcontrol.v1beta2.FlowSchema"
      kind="FlowSchema"
...
export const PriorityLevelConfiguration = ({
  ...
  return (
    <Resource
      id="io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfiguration"
  ...
  return (
    <Item
      ...
      contexts={[
        ...
        {
          id: "io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationSpec",
          path: "limited",
          isItem: false,
        },
      ]}
