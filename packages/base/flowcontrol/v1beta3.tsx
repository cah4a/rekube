...
export interface ILimitedPriorityLevelConfiguration {
   ...
   */
  nominalConcurrencyShares?: number | bigint;
}
...
export const FlowSchema = ({
  ...
  return (
    <Resource
      id="io.k8s.api.flowcontrol.v1beta3.FlowSchema"
      kind="FlowSchema"
...
export const PriorityLevelConfiguration = ({
  ...
  return (
    <Resource
      id="io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfiguration"
  ...
  return (
    <Item
      ...
      contexts={[
        ...
        {
          id: "io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationSpec",
          path: "limited",
          isItem: false,
        },
      ]}
  ...
  return (
    <Item
      ...
      contexts={[
        ...
        {
          id: "io.k8s.api.flowcontrol.v1beta3.FlowSchemaSpec",
          path: "rules",
          isItem: true,
        },
      ]}
